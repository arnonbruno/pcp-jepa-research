...
echo ""
echo "Key findings:"
echo "  1. Standard Latent JEPA rollout is brittle under contact-rich dropout (e.g. Hopper)"
...
echo ""
echo "Cite: PANO: Physics-Anchored Neural Observers for Hybrid Control (NeurIPS 2026 Submission)"
echo "================================================================================"
